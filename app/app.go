...
import (
	"fmt"
	v013 "github.com/furyaoff/fanfury/app/upgrades/v013"
	v014 "github.com/furyaoff/fanfury/app/upgrades/v014"
	"strings"

	v010 "github.com/furyaoff/fanfury/app/upgrades/v010"
	v011 "github.com/furyaoff/fanfury/app/upgrades/v011"
	"github.com/furyaoff/fanfury/x/fantoken"
	fantokenkeeper "github.com/furyaoff/fanfury/x/fantoken/keeper"
	fantokentypes "github.com/furyaoff/fanfury/x/fantoken/types"
	"github.com/furyaoff/fanfury/x/merkledrop"
	merkledropkeeper "github.com/furyaoff/fanfury/x/merkledrop/keeper"
	merkledroptypes "github.com/furyaoff/fanfury/x/merkledrop/types"
	...
	appparams "github.com/furyaoff/fanfury/app/params"
	fantokenclient "github.com/furyaoff/fanfury/x/fantoken/client"
	merkledropclient "github.com/furyaoff/fanfury/x/merkledrop/client"
	...
	_ "github.com/furyaoff/fanfury/swagger/statik"
)
...
func (app *FanfuryApp) setupUpgradeStoreLoaders() {
	...
	// v13 Upgrade
	if upgradeInfo.Name == v013.UpgradeName && !app.UpgradeKeeper.IsSkipHeight(upgradeInfo.Height) {
		storeUpgrades := store.StoreUpgrades{
