...
GENESIS_COINS=1000000000000000ufury

# Stop fanfuryd if it is already running 
...
# Initialize fanfuryd with "localnet" chain id
...
$BINARY --home $CHAIN_DIR/$CHAIN_ID gentx validator 1000000000ufury --chain-id $CHAIN_ID --keyring-backend test
